...
#include <atomic>  // TODO add this for linuxMint
...
extern "C" constexpr __declspec(dllexport) const char* getModName() { return MOD_NAME; }
extern "C" constexpr __declspec(dllexport) const char* getModVer() { return MOD_VER; }
